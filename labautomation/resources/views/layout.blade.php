...
<head>
    ...
    {{--  <!-- Choices.js-->  --}}
    <link rel="stylesheet" href="{{ assets('assets/vendor/choices.jsassets/styles/choices.min.css') }}">
    {{--  <!-- Google fonts - Muli-->  --}}
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ assets('assets/css/style.default.1da70351.css') }}" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{ assets('assets/css/custom.0a822280.css') }}">
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ assets('assets/img/favicon.3903ee9d.ico') }}">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg py-3 bg-dash-dark-2 border-bottom border-dash-dark-1 z-index-10">
          ...
          <div class="container-fluid d-flex align-items-center justify-content-between py-1">
            ...
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item dropdown px-lg-2"><a class="nav-link text-reset px-1 px-lg-0" id="navbarDropdownMenuLink1" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark" aria-labelledby="navbarDropdownMenuLink1">
                  <li><a class="dropdown-item d-flex align-items-center" href="#">
                      <div class="position-relative"><img class="avatar avatar-md" src="{{ assets('assets/img/avatar-3.d23ced61.jpg') }}" alt="Nadia Halsey">
                  ...
                  <li><a class="dropdown-item d-flex align-items-center" href="#">
                      <div class="position-relative"><img class="avatar avatar-md" src="{{ assets('assets/img/avatar-2.9eed705d.jpg') }}" alt="Peter Ramsy">
                        <div class="availability-status bg-warning"></div>
                      </div>
                      <div class="ms-3">   <strong class="d-block">Nadia Halsey</strong><span class="d-block text-xs">lorem ipsum dolor sit amit</span><small class="d-block">9:30am</small></div></a></li>
                  <li><a class="dropdown-item d-flex align-items-center" href="#">
                      <div class="position-relative"><img class="avatar avatar-md" src="{{ assets('assets/img/avatar-1.ce912d90.jpg') }}" alt="Sam Kaheil">
                        <div class="availability-status bg-danger"></div>
                      </div>
                      <div class="ms-3">   <strong class="d-block">Nadia Halsey</strong><span class="d-block text-xs">lorem ipsum dolor sit amit</span><small class="d-block">9:30am</small></div></a></li>
                  <li><a class="dropdown-item d-flex align-items-center" href="#">
                      <div class="position-relative"><img class="avatar avatar-md" src="{{ assets('assets/img/avatar-5.f8d832d9.jpg') }}" alt="Sara Wood">
              ...
              <li class="list-inline-item logout px-lg-2">                 <a class="nav-link text-sm text-reset px-1 px-lg-0" id="logout" href="https://demo.bootstrapious.com/dark-admin/2-0/login.html"> <span class="d-none d-sm-inline-block">Logout </span>
                      <svg class="svg-icon svg-icon-xs svg-icon-heavy">
    ...
    <script src="{{ assets('assets/vendor/just-validate/js/just-validate.min.js') }}"></script>
    <script src="{{ assets('assets/vendor/chart.js/Chart.min.js') }}"></script>
    <script src="{{ assets('assets/vendor/choices.jsassets/scripts/choices.min.js') }}"></script>
    <script src="{{ assets('assets/js/js-cookie.0d5f0e08.js') }}"> </script>
    <script src="{{ assets('assets/js/demo.bbd40f0c.js') }}"> </script>
    <script src="{{ assets('assets/js/charts-home.f7b8867a.js') }}"></script>
    <!-- Main File-->
    <script src="{{ assets('assets/js/front.df077648.js') }}"></script>
    <script>
      // ------------------------------------------------------- //
      //   Inject SVG Sprite -
      //   see more here
    ...
    <link rel="stylesheet" href="{{ assets('assets/css/all.css') }}" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
